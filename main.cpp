...
int main(void)
{
	...
	do {
		...
		//	Model = glm::rotate(Model, glm::radians(1.0f), glm::vec3(0.0f, 0.0f, 1.0f));
			...
			Model = glm::translate(+tri_center) * glm::rotate(glm::mat4(), glm::radians(turn_coeff_), glm::vec3(dir.x, dir.y, 1.0)) * glm::translate(-tri_center) * Model;
		...
		if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS)
		{
			...
			// rotation about the center of the triangle
			Model = glm::translate(glm::vec3(dir.x, ++dir.y, 1.0));
